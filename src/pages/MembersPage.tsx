...
export default function MembersPage() {
  ...
  const handleWhatsAppClick = (phone: string, name: string) => {
    const message = encodeURIComponent(
      `Olá ${name}, vim através do site CRESEX e gostaria de saber mais sobre seus serviços.`
    );
    ...
    <div className="pt-20">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-[#fafafa] mb-6">Nossos Membros</h1>
              ...
              <ScrollRevealTitle>
                <div className="text-center mb-12">
                  <p className="text-[#666666]">
                    {filteredMembers.length} profissional
                    {filteredMembers.length !== 1 ? "is" : ""} encontrado
                  ...
                  <ScrollRevealCard key={index} delay={index * 0.1}>
                    ...
                    >
                      ...
                      <div className="p-6 flex flex-col flex-1">
                        ...
                        <motion.button
                          onClick={() =>
                            handleWhatsAppClick(member.phone, member.name)
                          }
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-[#333333] to-black relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <ScrollRevealTitle>
            <h2 className="text-[#fafafa] mb-6">Seja um Membro CRESEX</h2>
            <p className="text-gray-400 mb-8 text-xl">
              Você é profissional da sexualidade e quer fazer parte do maior grupo do
              Brasil? Entre em contato e conheça os benefícios de ser membro CRESEX.
            </p>
            <motion.button
